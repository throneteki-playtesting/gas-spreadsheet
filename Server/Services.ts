...
export const dataService = new DataService(config.get("database.url"), config.get("google.clientEmail"), config.get("google.privateKey"));
export const renderService = new RenderingService();
export const discordService = new DiscordService(config.get("discord.token"), config.get("discord.clientId"));
