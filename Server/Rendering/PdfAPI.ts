...
// class PDFAPI {
//     static generateSheet(cards: Card[], fileName: string, sandbox = false): string {
...
//         const html = HTMLRenderEngine.batch(cards);
...
//     static getFileName(short: string, version: SemVer, type: BatchType) {
...
// export { PDFAPI, syncUpdatedPhysicalPDFSheet, syncLatestPhysicalPDFSheet };